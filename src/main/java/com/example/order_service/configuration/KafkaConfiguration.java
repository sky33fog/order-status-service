...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, OrderProcessEvent> kafkaOrderEventProducerFactory(ObjectMapper objectMapper) {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public KafkaTemplate<String, OrderProcessEvent> kafkaTemplate(ProducerFactory<String, OrderProcessEvent> kafkaOrderEventProducerFactory) {
